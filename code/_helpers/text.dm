...
/proc/fix_rus_nanoui(var/input)
	input = replacetext(input, "А", "&#1040;")
	input = replacetext(input, "Б", "&#1041;")
	input = replacetext(input, "В", "&#1042;")
	input = replacetext(input, "Г", "&#1043;")
	input = replacetext(input, "Д", "&#1044;")
	input = replacetext(input, "Е", "&#1045;")
	input = replacetext(input, "Ж", "&#1046;")
	input = replacetext(input, "З", "&#1047;")
	input = replacetext(input, "И", "&#1048;")
	input = replacetext(input, "Й", "&#1049;")
	input = replacetext(input, "К", "&#1050;")
	input = replacetext(input, "Л", "&#1051;")
	input = replacetext(input, "М", "&#1052;")
	input = replacetext(input, "Н", "&#1053;")
	input = replacetext(input, "О", "&#1054;")
	input = replacetext(input, "П", "&#1055;")
	input = replacetext(input, "Р", "&#1056;")
	input = replacetext(input, "С", "&#1057;")
	input = replacetext(input, "Т", "&#1058;")
	input = replacetext(input, "У", "&#1059;")
	input = replacetext(input, "Ф", "&#1060;")
	input = replacetext(input, "Х", "&#1061;")
	input = replacetext(input, "Ц", "&#1062;")
	input = replacetext(input, "Ч", "&#1063;")
	input = replacetext(input, "Ш", "&#1064;")
	input = replacetext(input, "Щ", "&#1065;")
	input = replacetext(input, "Ъ", "&#1066;")
	input = replacetext(input, "Ы", "&#1067;")
	input = replacetext(input, "Ь", "&#1068;")
	input = replacetext(input, "Э", "&#1069;")
	input = replacetext(input, "Ю", "&#1070;")
	input = replacetext(input, "Я", "&#1071;")
	input = replacetext(input, "а", "&#1072;")
	input = replacetext(input, "б", "&#1073;")
	input = replacetext(input, "в", "&#1074;")
	input = replacetext(input, "г", "&#1075;")

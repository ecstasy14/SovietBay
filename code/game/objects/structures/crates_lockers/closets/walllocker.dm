...
/obj/structure/closet/walllocker/emerglocker
	...
	var/list/spawnitems = list(/obj/item/weapon/tank/emergency/oxygen,/obj/item/clothing/mask/breath,/obj/item/device/flashlight,/obj/item/weapon/crowbar/red,/obj/item/device/radio/off)

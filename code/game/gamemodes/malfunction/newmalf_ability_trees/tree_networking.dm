...
/datum/game_mode/malfunction/verb/system_override()
	...
	command_announcement.Announce("Наши системные администраторы сообщили, что мы были отрезаны от управлени&#255; вашей сетью. Кто бы ни сделал это, он теперь имеет полный контроль над системами станции.", "Центр управлени&#255; сетью")

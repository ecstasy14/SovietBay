//Config stuff
#define BREACH_MOVETIME 600	//Time to station is milliseconds. 60 seconds, enough time for everyone to be on the shuttle before it leaves.
#define BREACH_STATION_AREATYPE "/area/shuttle/breach/station" //Type of the spec ops shuttle area for station
#define BREACH_DOCK_AREATYPE "/area/shuttle/breach/centcom"	//Type of the spec ops shuttle area for dock

var/breach_shuttle_moving_to_station = 0
var/breach_shuttle_moving_to_mothership = 0
var/breach_shuttle_at_station = 0
var/breach_shuttle_can_send = 1
var/breach_shuttle_time = 0
var/breach_shuttle_timeleft = 0

/obj/machinery/computer/breach_shuttle
	name = "breach shuttle control console"
...
/proc/breach_process()
	var/area/centcom/breach/control/syndicate_ship = locate()//To find announcer. This area should exist for this proc to work.
	var/area/centcom/breach/elite_squad/elite_squad = locate()//Where is the specops area located?

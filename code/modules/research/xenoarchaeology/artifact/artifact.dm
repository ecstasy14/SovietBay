...
/*	100;/obj/item/device/jirachistone,\ */ // Zap-zapper. This: code\modules\research\xenoarchaeology\artifact\artifact.dm:24:error: /obj/item/device/jirachistone: undefined type path

...
/datum/language/binary/broadcast(var/mob/living/speaker,var/message,var/speaker_mask)
	...
	for (var/mob/living/S in living_mob_list_)
		if(drone_only && !istype(S,/mob/living/silicon/robot/drone))
			...
			message_start = "<i><span class='game say'>[name], <a href='byond://?src=\ref[S];track2=\ref[S];track=\ref[speaker];trackname=[lhtml_encode(speaker.name)]'><span class='name'>[speaker.name]</span></a></span></i>"

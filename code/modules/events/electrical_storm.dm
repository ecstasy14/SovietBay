...
/datum/event/electrical_storm/announce()
	...
	switch(severity)
		if(EVENT_LEVEL_MUNDANE)
			command_announcement.Announce("Ваша станция проходит через слабый электромагнитный шторм Пожалуйста, проследите за чувствительным электрическим оборудованием.", "Тревога: Электромагнитный шторм")
		if(EVENT_LEVEL_MODERATE)
			command_announcement.Announce("Ваша станция проходит через электромагнитный шторм. Пожалуйста, обезопасьте чувствительное электрическое оборудование.", "Тревога: Электромагнитный штормt")
		if(EVENT_LEVEL_MAJOR)
			command_announcement.Announce("Внимание! Ваша станция проходит через сильный электромагнитный шторм. Рекомендуется немедленно обезопасить чувствительное электрическое оборудование до окончания шторма.", "Тревога: Электромагнитный шторм")

...
/datum/event/electrical_storm/announce()
	...
	switch(severity)
		...
		if(EVENT_LEVEL_MODERATE)
			command_announcement.Announce("Ваша станция проходит через электромагнитный шторм. Пожалуйста, обезопасьте чувствительное электрическое оборудование.", "Тревога: Электромагнитный шторм")

...
/datum/event/infestation/announce()
	command_announcement.Announce("Ѕиосканеры обнаружили размножение [vermstring] в \the [location]. ќчистите место от паразитов, пока они не начали наносить ущерб продуктивности.", "«аражение вредител&#255;ми")
